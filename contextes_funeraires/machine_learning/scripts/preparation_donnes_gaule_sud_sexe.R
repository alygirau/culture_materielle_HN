...
# sont retirées. NB : cette liste de catégories exclues est identique à
# celle du script équivalent pour la Gaule du nord.
...
# vides suite au filtrage ci-dessus
...
# ============================================================
# Regroupements identiques au script équivalent pour la Gaule du nord (voir
# ce script pour le détail) : parure/vêtement, équipement de consommation
# alimentaire, récipient de stockage, armement, artisanat, soins du corps,
# équipement culturel.
...
# ============================================================
# Seules les sépultures situées en Gaule du sud sont conservées pour cette analyse
...
# ============================================================
# L'intervalle est calculé à partir du centre de la fourchette chronologique
# (moyenne entre phase_date_debut et phase_date_fin), ce qui donne une
# estimation plus représentative pour des datations en fourchette (typiques
# des sépultures) qu'un simple découpage sur la date de début seule.
