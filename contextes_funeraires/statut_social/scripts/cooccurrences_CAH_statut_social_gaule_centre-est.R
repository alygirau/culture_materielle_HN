####
# Analyse des cooccurrences par groupe CAH — Gaule du centre-est
...
# statut.
df <- read.csv2("data/cah_gaule_centre-est.csv",
                header = TRUE,
                encoding = "utf8",
                row.names = "ID")
...
# NB : à la différence des scripts sexe/âge, les erreurs de calcul (par
# exemple des effectifs insuffisants même pour Fisher) sont ici interceptées
# par tryCatch et donnent une p-value par défaut de 1 (aucune conclusion
# statistique), plutôt que de faire planter le script.
